...
class GestureCreation:
    ...
    def __init__(self):
        ...
        self.gesture_destination = 'irish_sign_language_gestures'  # Gesture storage directory name
        self.gesture_db = 'irish_sign_language_gestures_db.db'  # Database
        self.cap = None
        self.kernel = None
        self.gesture_count = 1000  # Number of gestures to be captured
        self.capture_no = 0
        self.start_capturing_gesture = False
        self.frame_count = 0
        self.image_dimension_x = 50  # Final image width
        self.image_dimension_y = 50  # Final image height
    ...
    def capture_gesture(self):
        ...
        while True:
            ...
            cv2.putText(img, str(self.capture_no), (30, 400), cv2.FONT_HERSHEY_TRIPLEX, 1.5, (127, 127, 255))
