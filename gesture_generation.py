...
class GestureCreation:
    ...
    def gesture_details_data(self):
        ...
        :return: None
        """
        ''' taking gesture id and checking it should be a valid number and exiting the program on user cancellation'''
        try:
        ...
        ''' taking gesture details and exiting the program on user cancellation'''
        ...
        try:
            ...
            choice = pymsgbox.confirm('Gesture with this ID already exists. Want to change the record?',
                                      'Confirm', ["Yes", 'No'])  # checking already existing gesture
            if choice.lower() == 'yes':
