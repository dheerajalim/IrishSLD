...
class ModelDumping:
    ...
    def __dump_model(model_name , model):
        try:
            with open(cnf.PROJECT_FOLDER+'/'+model_name, 'wb') as model_dump:
    ...
    def train_set(self):
        ...
        pymsgbox.alert('Generating Training Model...', 'Message', button='Wait', timeout=500)
    ...
    def test_set(self):
        ...
        pymsgbox.alert('Generating Test Model...', 'Message', button='Wait', timeout=500)
    ...
    def validation_set(self):
        ...
        pymsgbox.alert('Generating Validation Model...', 'Message', button='Wait', timeout=500)
